...
// __SCRIPT_SEPARATOR__ - info:7b226e616d65223a22756e6f227d
jsc.uno.request = function(apiKey, dataObj, fullReturn) { 
  var options = {
...
jsc.uno.setOverlayContentField = function(apiKey, id, fieldId, value) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.getOverlayModel = function(apiKey, id) {
    return jsc.uno.request(apiKey, {
        command: "GetOverlayModel",
        id: id
    }, true); // usamos fullReturn = true para acessar model.data
};

jsc.uno.takeOverlaySlotName = function(apiKey, id, slotName) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.takeOverlaySlotNumber = function(apiKey, id, slotNumber) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.takeOverlayFirstSlot = function(apiKey, id) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.takeOverlayNextSlot = function(apiKey, id) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.takeOverlayPreviousSlot = function(apiKey, id) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.takeOverlayLastSlot = function(apiKey, id) {
    return jsc.uno.request(apiKey, {
...
// Timer Controls
jsc.uno.setTimer = function(apiKey, seconds) {
    return jsc.uno.request(apiKey, {
        command: "SetTimer",
        value: seconds
    });
...
jsc.uno.startTimer = function(apiKey) {
    return jsc.uno.request(apiKey, {
        command: "StartTimer"
    });
};

jsc.uno.pauseTimer = function(apiKey) {
    return jsc.uno.request(apiKey, {
        command: "PauseTimer"
    });
};

jsc.uno.playTimer = function(apiKey) {
    return jsc.uno.request(apiKey, {
        command: "PlayTimer"
    });
};

jsc.uno.resetTimer = function(apiKey) {
    return jsc.uno.request(apiKey, {
        command: "ResetTimer"
    });
};

jsc.uno.getTimer = function(apiKey) {
    return jsc.uno.request(apiKey, {
        command: "GetTimer"
    }, true);
};

jsc.uno.increaseTimer = function(apiKey, value) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.decreaseTimer = function(apiKey, value) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.setBeginTimer = function(apiKey, seconds) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.getBeginTime = function(apiKey) {
    return jsc.uno.request(apiKey, {
        command: "GetBeginTime"
    });
};

jsc.uno.setUseMessage = function(apiKey, enabled) {
    return jsc.uno.request(apiKey, {
...
jsc.uno.getUseMessage = function(apiKey) {
    return jsc.uno.request(apiKey, {
        command: "GetUseMessage"
    });
};

jsc.uno.setTimerMessage = function(apiKey, message) {
    return jsc.uno.request(apiKey, {
        command: "SetMessage",
        value: message
    });
...
jsc.uno.getTimerMessage = function(apiKey) {
    return jsc.uno.request(apiKey, {
        command: "GetMessage"
    });
};
