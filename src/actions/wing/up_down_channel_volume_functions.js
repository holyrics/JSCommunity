function hGetItemStatusData(obj) {
    var muted = jsc.wing.isChannelMute(obj.input.receiver_id, obj.input.channel);
    var description = (jsc.wing.getChannelVolume(obj.input.receiver_id, obj.input.channel) * 100).toFixed(0) + "%";
    return {
          active: muted,
